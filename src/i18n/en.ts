const en = {
  ...
  source: 'Source',
  match: 'Match',
  openConnections: 'Open full connections',
  openDeviceConnections: 'Open this device connections',
  deviceStatus: 'Device status',
  loadingDeviceStatus: 'Loading device policies...',
  defaultPolicy: 'Default policy',
  deviceOverrides: 'Device overrides',
  domainRules: 'domain rules',
  portRules: 'port rules',
  devicePolicy: 'Default device policy',
  devicePolicyDescription:
    'INHERIT follows the household rules; choose a group or node only for this device.',
  inheritGlobal: 'Inherit household rules',
  overrideGlobal: 'Device override',
  policyTargetPlaceholder: 'Search or enter a policy group / node',
  policyTargetTip: 'Type to locate a group quickly. DIRECT and REJECT are also available.',
  deviceIdentity: 'Device identity',
  deviceIdentityDescription: 'The source IP is used to match this device in Mihomo.',
  domainOverrides: 'Domain overrides',
  domainOverridesDescription: 'Only this device uses these domain-specific exits.',
  exactDomain: 'Exact domain',
  domainSuffix: 'Domain suffix',
  domainPlaceholder: 'example.com',
  noDomainOverrides: 'No domain overrides',
  portOverrides: 'Port overrides',
  portOverridesDescription: 'Route inbound or destination ports independently for this device.',
  inboundPort: 'Inbound port',
  destinationPort: 'Destination port',
  portPlaceholder: '42001 or 42001-42005',
  portCondition: 'Port condition',
  noPortOverrides: 'No port overrides',
  deviceConnections: 'Live device connections',
  deviceConnectionsDescription: 'Only active connections whose source IP is this device.',
  noDeviceConnections: 'No active connections for this device',
  noDevices: 'No device policy or online device data',
  deviceUpdateSuccess: 'Device policy updated',
  deviceScope: 'Current device scope',
  deviceScopeDescription:
    'Changes in this page apply only to the selected device. The proxy page without a device scope is global.',
  deviceSearchPlaceholder: 'Search device name / IP',
  bypassed: 'Bypassed Mihomo',
  deviceRuleOrder: 'Match order',
  targetNotFound: 'Target not found in current proxy list',
  targetRecognized: 'Target recognized',
  loadingProviders: 'Loading provider details...',
  providersNotLoaded: 'not loaded',
  ruleOverrides: 'Rule overrides',
  ruleOverridesStatus: '{count} active overrides',
  addRuleOverride: 'Add high-priority rule',
  ruleOverrideDescription: 'Applies immediately and stays above the household rule list.',
  ruleOverrideDomainPlaceholder: 'Domain or URL, for example stream.example.com',
  ruleOverrideTargetTip: 'Choose a policy group, node, DIRECT, or REJECT.',
  ruleOverrideHotReload: 'Validated and hot-reloaded without restarting Mihomo',
  householdRules: 'Household rules',
  activeRuleOverrides: 'Active overrides',
  noRuleOverrides: 'No rule overrides',
  ruleOverrideUpdateSuccess: 'Rule overrides updated',
  deleteRuleOverrideConfirm: 'Delete the override for {domain}?',
  ...
  proxyGroupLayout: 'Custom folder layout',
  addProxyFolder: 'New folder',
  editProxyFolder: 'Edit folder',
  proxyFolderHeight: 'Folder height',
  proxyFolderHeightOpen: 'No limit',
  proxyFolderName: 'Folder name',
  proxyFolderWidth: 'Collapsed width',
  proxyGroupsCount: 'proxy groups',
  dropProxyGroupHere: 'Drop proxy groups into this folder',
  columns: 'columns',
  editLayout: 'Edit layout',
  finishLayoutEditing: 'Done',
  dragToReorder: 'Drag to reorder',
  resetProxyLayoutConfirm: 'Reset all folders, assignments, and ordering?',
  type: 'Type',
  process: 'Process',
