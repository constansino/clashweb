...
const ru: LANG_MESSAGE = {
  ...
  source: 'Источник',
  match: 'Совпадение',
  openConnections: 'Открыть все подключения',
  openDeviceConnections: 'Открыть подключения устройства',
  deviceStatus: 'Состояние устройства',
  loadingDeviceStatus: 'Загрузка политик устройства...',
  defaultPolicy: 'Политика по умолчанию',
  deviceOverrides: 'Переопределения устройства',
  domainRules: 'правил доменов',
  portRules: 'правил портов',
  devicePolicy: 'Политика устройства',
  devicePolicyDescription:
    'INHERIT использует домашние правила; группу или узел можно выбрать только для этого устройства.',
  inheritGlobal: 'Наследовать домашние правила',
  overrideGlobal: 'Переопределение устройства',
  policyTargetPlaceholder: 'Найти группу или узел политики',
  policyTargetTip: 'Введите текст для быстрого поиска группы. Также доступны DIRECT и REJECT.',
  deviceIdentity: 'Идентификатор устройства',
  deviceIdentityDescription: 'Mihomo сопоставляет устройство по исходному IP.',
  domainOverrides: 'Переопределения доменов',
  domainOverridesDescription: 'Только это устройство использует эти выходы для доменов.',
  exactDomain: 'Точный домен',
  domainSuffix: 'Суффикс домена',
  domainPlaceholder: 'например example.com',
  noDomainOverrides: 'Нет переопределений доменов',
  portOverrides: 'Переопределения портов',
  portOverridesDescription: 'Независимая маршрутизация входящих портов или портов назначения.',
  inboundPort: 'Входящий порт',
  destinationPort: 'Порт назначения',
  portPlaceholder: '42001 или 42001-42005',
  portCondition: 'Условие порта',
  noPortOverrides: 'Нет переопределений портов',
  deviceConnections: 'Активные подключения устройства',
  deviceConnectionsDescription: 'Показываются подключения только с исходным IP этого устройства.',
  noDeviceConnections: 'Нет активных подключений',
  noDevices: 'Нет данных об устройствах',
  deviceUpdateSuccess: 'Политика устройства обновлена',
  deviceScope: 'Текущий контекст устройства',
  deviceScopeDescription:
    'Изменения здесь относятся только к выбранному устройству. Страница прокси без устройства глобальна.',
  deviceSearchPlaceholder: 'Поиск имени устройства / IP',
  bypassed: 'В обход Mihomo',
  deviceRuleOrder: 'Порядок совпадений',
  targetNotFound: 'Цель не найдена в текущем списке прокси',
  targetRecognized: 'Цель распознана',
  loadingProviders: 'Загрузка данных провайдеров...',
  providersNotLoaded: 'не загружены',
  ruleOverrides: 'Переопределения правил',
  ruleOverridesStatus: 'Активных переопределений: {count}',
  addRuleOverride: 'Добавить правило с высоким приоритетом',
  ruleOverrideDescription: 'Применяется сразу и имеет приоритет над основными правилами.',
  ruleOverrideDomainPlaceholder: 'Домен или URL, например stream.example.com',
  ruleOverrideTargetTip: 'Выберите группу, узел, DIRECT или REJECT.',
  ruleOverrideHotReload: 'Проверка и горячая загрузка без перезапуска Mihomo',
  householdRules: 'Основные правила',
  activeRuleOverrides: 'Активные переопределения',
  noRuleOverrides: 'Нет переопределений',
  ruleOverrideUpdateSuccess: 'Переопределения обновлены',
  deleteRuleOverrideConfirm: 'Удалить переопределение для {domain}?',
  ...
  proxyGroupColumns: 'Столбцы групп прокси',
  proxyGroupLayout: 'Макет папок',
  addProxyFolder: 'Новая папка',
  editProxyFolder: 'Изменить папку',
  proxyFolderHeight: 'Высота папки',
  proxyFolderHeightOpen: 'Без ограничения',
  proxyFolderName: 'Имя папки',
  proxyFolderWidth: 'Ширина в свёрнутом виде',
  proxyGroupsCount: 'групп',
  dropProxyGroupHere: 'Перетащите группы в эту папку',
  columns: 'столбцы',
  editLayout: 'Изменить макет',
  finishLayoutEditing: 'Готово',
  dragToReorder: 'Перетащите для сортировки',
  resetProxyLayoutConfirm: 'Сбросить все папки, назначения и порядок?',
  type: 'Тип',
  process: 'Процесс',
  connectTime: 'Время',
