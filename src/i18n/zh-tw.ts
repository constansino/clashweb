...
const zhTW: LANG_MESSAGE = {
  ...
  source: '來源',
  match: '匹配',
  openConnections: '開啟完整連接頁',
  openDeviceConnections: '開啟本設備連接',
  deviceStatus: '設備狀態',
  loadingDeviceStatus: '正在載入設備策略...',
  defaultPolicy: '預設策略',
  deviceOverrides: '設備例外',
  domainRules: '條域名規則',
  portRules: '條端口規則',
  devicePolicy: '設備預設策略',
  devicePolicyDescription: 'INHERIT 繼承全家的規則；只有需要時才為該設備選擇策略組或節點。',
  inheritGlobal: '繼承家庭規則',
  overrideGlobal: '設備獨立策略',
  policyTargetPlaceholder: '搜尋或輸入策略組 / 節點',
  policyTargetTip: '可直接輸入文字快速定位策略組，也可以選擇 DIRECT 或 REJECT。',
  deviceIdentity: '設備身份',
  deviceIdentityDescription: 'Mihomo 使用來源 IP 來匹配這台設備。',
  domainOverrides: '域名例外',
  domainOverridesDescription: '只有這台設備存取這些域名時使用指定出口。',
  exactDomain: '完整域名',
  domainSuffix: '域名後綴',
  domainPlaceholder: '例如 example.com',
  noDomainOverrides: '暫無域名例外',
  portOverrides: '端口例外',
  portOverridesDescription: '可為這台設備獨立控制入站端口或目標端口。',
  inboundPort: '入站端口',
  destinationPort: '目標端口',
  portPlaceholder: '42001 或 42001-42005',
  portCondition: '端口條件',
  noPortOverrides: '暫無端口例外',
  deviceConnections: '設備即時連接',
  deviceConnectionsDescription: '只顯示來源 IP 屬於目前設備的活躍連接。',
  noDeviceConnections: '目前設備暫無活躍連接',
  noDevices: '暫無設備策略或線上設備資料',
  deviceUpdateSuccess: '設備策略已更新',
  deviceScope: '目前設備範圍',
  deviceScopeDescription: '本頁修改只作用於目前設備；不帶設備範圍的代理頁仍然是全域設定。',
  deviceSearchPlaceholder: '搜尋設備名稱 / IP',
  bypassed: '已繞過 Mihomo',
  deviceRuleOrder: '匹配順序',
  targetNotFound: '目前代理列表中沒有這個目標',
  targetRecognized: '目標已識別',
  loadingProviders: '正在載入供應商詳情...',
  providersNotLoaded: '未載入',
  ruleOverrides: '規則覆寫',
  ruleOverridesStatus: '已生效 {count} 條覆寫',
  addRuleOverride: '新增高優先級規則',
  ruleOverrideDescription: '儲存後立即生效，並持續位於家庭原始規則之前。',
  ruleOverrideDomainPlaceholder: '網域或 URL，例如 stream.example.com',
  ruleOverrideTargetTip: '可選擇策略組、節點、DIRECT 或 REJECT。',
  ruleOverrideHotReload: '驗證後熱載，不重啟 Mihomo',
  householdRules: '家庭原始規則',
  activeRuleOverrides: '目前生效的覆寫',
  noRuleOverrides: '尚無規則覆寫',
  ruleOverrideUpdateSuccess: '規則覆寫已熱載',
  deleteRuleOverrideConfirm: '刪除 {domain} 的覆寫規則？',
  ...
  proxyGroupColumns: '代理組欄數',
  proxyGroupLayout: '自訂資料夾佈局',
  addProxyFolder: '新增資料夾',
  editProxyFolder: '編輯資料夾',
  proxyFolderHeight: '資料夾高度',
  proxyFolderHeightOpen: '不限',
  proxyFolderName: '資料夾名稱',
  proxyFolderWidth: '摺疊時寬度',
  proxyGroupsCount: '個策略組',
  dropProxyGroupHere: '將策略組拖到此資料夾',
  columns: '欄',
  editLayout: '編輯佈局',
  finishLayoutEditing: '完成',
  dragToReorder: '拖曳排序',
  resetProxyLayoutConfirm: '確定重設資料夾、歸屬與排序嗎？',
  type: '類型',
  process: '進程',
  connectTime: '連接時間',
  sourcePort: '源端口',
