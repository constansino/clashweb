...
const zh: LANG_MESSAGE = {
  ...
  source: '来源',
  match: '匹配',
  openConnections: '打开完整连接页',
  openDeviceConnections: '打开本设备连接',
  deviceStatus: '设备状态',
  loadingDeviceStatus: '正在加载设备策略...',
  defaultPolicy: '默认策略',
  deviceOverrides: '设备例外',
  domainRules: '条域名规则',
  portRules: '条端口规则',
  devicePolicy: '设备默认策略',
  devicePolicyDescription: 'INHERIT 继承全家的规则；只有需要时才为该设备选择策略组或节点。',
  inheritGlobal: '继承家庭规则',
  overrideGlobal: '设备独立策略',
  policyTargetPlaceholder: '搜索或输入策略组 / 节点',
  policyTargetTip: '可直接输入文字快速定位策略组，也可以选择 DIRECT 或 REJECT。',
  deviceIdentity: '设备身份',
  deviceIdentityDescription: 'Mihomo 使用源 IP 来匹配这台设备。',
  domainOverrides: '域名例外',
  domainOverridesDescription: '只有这台设备访问这些域名时使用指定出口。',
  exactDomain: '完整域名',
  domainSuffix: '域名后缀',
  domainPlaceholder: '例如 example.com',
  noDomainOverrides: '暂无域名例外',
  portOverrides: '端口例外',
  portOverridesDescription: '可为这台设备独立控制入站端口或目标端口。',
  inboundPort: '入站端口',
  destinationPort: '目标端口',
  portPlaceholder: '42001 或 42001-42005',
  portCondition: '端口条件',
  noPortOverrides: '暂无端口例外',
  deviceConnections: '设备实时连接',
  deviceConnectionsDescription: '只显示源 IP 属于当前设备的活跃连接。',
  noDeviceConnections: '当前设备暂无活跃连接',
  noDevices: '暂无设备策略或在线设备数据',
  deviceUpdateSuccess: '设备策略已更新',
  deviceScope: '当前设备范围',
  deviceScopeDescription: '本页修改只作用于当前设备；不带设备范围的代理页仍然是全局设置。',
  deviceSearchPlaceholder: '搜索设备名称 / IP',
  bypassed: '已旁路 Mihomo',
  deviceRuleOrder: '匹配顺序',
  targetNotFound: '当前代理列表中没有这个目标',
  targetRecognized: '目标已识别',
  loadingProviders: '正在加载供应商详情...',
  providersNotLoaded: '未加载',
  ruleOverrides: '规则覆写',
  ruleOverridesStatus: '已生效 {count} 条覆写',
  addRuleOverride: '添加高优先级规则',
  ruleOverrideDescription: '保存后立即生效，并持续位于家庭原始规则之前。',
  ruleOverrideDomainPlaceholder: '域名或 URL，例如 stream.example.com',
  ruleOverrideTargetTip: '可选择策略组、节点、DIRECT 或 REJECT。',
  ruleOverrideHotReload: '校验后热载，不重启 Mihomo',
  householdRules: '家庭原始规则',
  activeRuleOverrides: '当前生效的覆写',
  noRuleOverrides: '暂无规则覆写',
  ruleOverrideUpdateSuccess: '规则覆写已热载',
  deleteRuleOverrideConfirm: '删除 {domain} 的覆写规则？',
  ...
  proxyGroupColumns: '代理组列数',
  proxyGroupLayout: '自定义文件夹布局',
  addProxyFolder: '新建文件夹',
  editProxyFolder: '编辑文件夹',
  proxyFolderHeight: '文件夹高度',
  proxyFolderHeightOpen: '不限',
  proxyFolderName: '文件夹名称',
  proxyFolderWidth: '折叠时宽度',
  proxyGroupsCount: '个策略组',
  dropProxyGroupHere: '将策略组拖到此文件夹',
  columns: '列',
  editLayout: '编辑布局',
  finishLayoutEditing: '完成',
  dragToReorder: '拖拽排序',
  resetProxyLayoutConfirm: '确定重置文件夹、归属和排序吗？',
  type: '类型',
  process: '进程',
  connectTime: '连接时间',
  sourcePort: '源端口',
